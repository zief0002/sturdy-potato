...
$$
\text{Percentage} = 0.8 \bigg(\frac{\text{Points earned on all labs}}{\text{Total points on all labs}}\bigg) + 0.2\bigg(\frac{\text{Number of Exit Tickets completed}}{\text{Total number of Exit Tickets}}\bigg)
$$
